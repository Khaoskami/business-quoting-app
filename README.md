...
Production email verification and password resets are delivered through Resend when RESEND_API_KEY and EMAIL_FROM are configured. The app also queues quote, invoice, reminder, and direct client emails, with monthly client-email allowances enforced by plan. System authentication emails are not charged against the customer's in-app client-email allowance. citeturn967677view0
